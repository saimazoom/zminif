...
LIB zx_pxy2saddr, zx_saddrpdown
...
x_fine:
   ...
   ;cp 192                      ; will char draw off screen?
   ...
   call zx_pxy2saddr           ; change pixel coord in hl to screen address in hl
   jr chk_loop
...
no_rotate:
   ...
   inc l
   inc l
   xor (hl)                     ; rightmost byte A to screen
   ...
   call zx_saddrpdown          ; modify screen address in HL to move down one pixel
